...
<?php if ( ! is_ajax() ) : ?><div id="order_review"><?php endif; ?>
	...
	<div class="panel panel-default">
		<div class="panel-heading">
			<h3 class="panel-title">
				<i class="fa fa-cubes text-primary"></i> Your Order
			</h3>
		</div>
	...
	<a href="<?php echo get_permalink( get_option( 'woocommerce_cart_page_id' ) ); ?>" class="btn btn-default">
		<i class="fa fa-shopping-cart text-primary"></i> Edit Your Cart
	</a>
	...
	<div id="payment">
		...
		<div class="form-row place-order">
			...
			echo apply_filters( 'woocommerce_order_button_html', '<input type="submit" class="btn btn-success btn-lg btn-block" name="woocommerce_checkout_place_order" id="place_order" value="' . esc_attr( $order_button_text ) . '" data-value="' . esc_attr( $order_button_text ) . '" />' );
			?>
