...
<form class="variations_form cart" method="post" enctype='multipart/form-data' data-product_id="<?php echo $post->ID; ?>" data-product_variations="<?php echo esc_attr( json_encode( $available_variations ) ) ?>">
	<?php if ( ! empty( $available_variations ) ) : ?>
		<div class="variations space-bottom20">
					...
					<div class="row variation">
						...
						<?php
							if ( sizeof( $attributes ) == $loop )
								echo '<a class="reset_variations btn btn-default btn-xs" href="#reset"><i class="fa fa-refresh text-primary"></i> Reset selection</a>';
						?>
					</div>
					</div>
		        <?php endforeach;?>
		...
		<div class="single_variation_wrap" style="display:none;">
			...
			<div class="single_variation pull-left"></div>
