...
if ( $customer_orders ) : ?>
	...
	<table class="shop_table my_account_orders table table-striped table-hover table-bordered">
						...
						<?php
							...
							if ($actions) {
								foreach ( $actions as $key => $action ) {
									echo '<a href="' . esc_url( $action['url'] ) . '" class="btn btn-sm btn-primary ' . sanitize_html_class( $key ) . '">' . esc_html( $action['name'] ) . '</a>';
								}
							}
						?>
					</td>
