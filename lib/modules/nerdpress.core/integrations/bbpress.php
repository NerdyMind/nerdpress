...
function nerdpress_bbp_topic_class( $classes ) {
	$classes[] = 'row';
	$classes[] = 'list-unstyled';
	$classes[] = nerdpress_bbps_get_topic_status();
 ...
 */
function nerdpress_bbp_form_topic_type_dropdown( $args = '' ) {
	echo nerdpress_bbp_get_form_topic_type_dropdown( $args );
}
	/**
	 ...
	 */
	function nerdpress_bbp_get_form_topic_type_dropdown( $args = '' ) {
 ...
 */
function nerdpress_bbp_form_topic_status_dropdown( $args = '' ) {
	echo nerdpress_bbp_get_form_topic_status_dropdown( $args );
}
	/**
	 ...
	 *  - selected: Override the selected option
	 */
	function nerdpress_bbp_get_form_topic_status_dropdown( $args = '' ) {
 ...
 */
function nerdpress_bbp_user_subscribe_link( $args = '', $user_id = 0, $wrap = true ) {
	echo nerdpress_bbp_get_user_subscribe_link( $args, $user_id, $wrap );
}
	/**
	 ...
	 */
	function nerdpress_bbp_get_user_subscribe_link( $args = '', $user_id = 0, $wrap = true ) {
 ...
 */
function nerdpress_bbp_user_favorites_link( $args = array(), $user_id = 0, $wrap = true ) {
	echo nerdpress_bbp_get_user_favorites_link( $args, $user_id, $wrap );
}
	/**
	 * User favorites link
	 *
	 ...
	 */
	function nerdpress_bbp_get_user_favorites_link( $args = '', $user_id = 0, $wrap = true ) {
...
add_action('bbp_template_before_single_topic', 'nerdpress_bbps_add_support_forum_features');
function nerdpress_bbps_add_support_forum_features(){	
		...
		<div id ="bbps_support_forum_move">
			<form id="bbps-topic-move" class="form-horizontal" role="form" name="bbps_support_topic_move" action="" method="post">
				<div class="form-group">
					<label for="bbp_forum_id" class="control-label">Move topic to: </label><?php nerdpress_bbp_dropdown(); ?>
 ...
 */
function nerdpress_bbp_dropdown( $args = '' ) {
	echo nerdpress_bbp_get_dropdown( $args );
}
	/**
	 ...
	 */
	function nerdpress_bbp_get_dropdown( $args = '' ) {
