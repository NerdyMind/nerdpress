...
<div class="nerdpress-social-share">
	<ul class="list-inline">
		<li>
			<a href="#share-facebook" class="btn btn-sm btn-social btn-facebook" data-network="Facebook" data-share="http://www.facebook.com/sharer.php?s=100&amp;p[title]=<?= $social_title;?>&amp;p[summary]=<?= $social_summary;?>&amp;p[url]=<?= $social_url; ?>&amp;&p[images][0]=<?= $social_image;?>">
		...
		<li>
			<a href="#share-twitter" class="btn btn-sm btn-social btn-twitter" data-network="Twitter" data-share="https://twitter.com/share?url=<?= $social_url; ?>">
				<i class="fa fa-twitter fa-lg"></i> Tweet <span class="badge"><?= ( $shared_counts['Twitter'] > 0 ) ? $shared_counts['Twitter'] : ''; ?></span>
			</a>
		</li>
		
		<li>
			<a href="#share-google-plus" class="btn btn-sm btn-social btn-google-plus" data-network="Google Plus" data-share="https://plus.google.com/share?url=<?= $social_url; ?>">
				<i class="fa fa-google-plus fa-lg"></i> +1 <span class="badge"><?= ( $shared_counts['GooglePlusOne'] > 0 ) ? $shared_counts['GooglePlusOne'] : ''; ?></span>
			</a>
		</li>
		
		<li>
			<a href="#share-linked-in" class="btn btn-sm btn-social btn-linkedin" data-network="LinkedIn" data-share="http://www.linkedin.com/shareArticle?mini=true&url=<?= $social_url; ?>&title=<?= $social_title;?>&summary=<?= $social_summary;?>&source=<? bloginfo( 'name' ); ?>">
				<i class="fa fa-linkedin fa-lg"></i> Share <span class="badge"><?= ( $shared_counts['LinkedIn'] > 0 ) ? $shared_counts['LinkedIn'] : ''; ?></span>
			</a>
		</li>
		
		<li>
			<a href="#share-pinterest" class="btn btn-sm btn-social btn-pinterest" data-network="Pinterest" data-share="//www.pinterest.com/pin/create/button/?url=<?= $social_url; ?>&description=<?= $social_title; ?>">
